...
"""
from question_ask import jena_sparql_endpoint,question2sparql
import os
...
class QAInterface:
    def __init__(self):
        ...
        self.q2s = question2sparql.Question2Sparql([os.path.join(file_path, './disizhang_object/disanzhang_name.txt'),
                                                    os.path.join(file_path, './disizhang_object/disizhang_object.txt')])
